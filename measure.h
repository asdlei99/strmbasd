...
void WINAPI DLL_EXPORT Msr_Init(void);


// Call this last to clean up (or just let it fall off the end - who cares?)

void WINAPI DLL_EXPORT Msr_Terminate(void);
...
int  WINAPI DLL_EXPORT Msr_Register(__in LPTSTR Incident);


// Reset the statistical counts for an incident

void WINAPI DLL_EXPORT Msr_Reset(int Id);
...
void WINAPI DLL_EXPORT Msr_Control(int iAction);


// log the start of an operation

void WINAPI DLL_EXPORT Msr_Start(int Id);


// log the end of an operation

void WINAPI DLL_EXPORT Msr_Stop(int Id);


// log a one-off or repetitive operation

void WINAPI DLL_EXPORT Msr_Note(int Id);


// log an integer (on which we can see statistics later)
void WINAPI DLL_EXPORT Msr_Integer(int Id, int n);
...
void WINAPI DLL_EXPORT Msr_Dump(HANDLE hFile);


// just dump the statistics - never mind the log

void WINAPI DLL_EXPORT Msr_DumpStats(HANDLE hFile);
