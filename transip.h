...
class DLL_EXPORT CTransInPlaceFilter;
...
class DLL_EXPORT CTransInPlaceInputPin : public CTransformInputPin
{
...
public:
    ...
    STDMETHODIMP DLL_EXPORT EnumMediaTypes( __deref_out IEnumMediaTypes **ppEnum );
    ...
    // going to use.
    STDMETHODIMP DLL_EXPORT NotifyAllocator(IMemAllocator * pAllocator,
                                 BOOL bReadOnly);

    // Allow the filter to see what allocator we have
    // N.B. This does NOT AddRef
    __out IMemAllocator * DLL_EXPORT PeekAllocator() const
        {  return m_pAllocator; }
    ...
    inline const BOOL DLL_EXPORT ReadOnly() { return m_bReadOnly ; }
...
class DLL_EXPORT CTransInPlaceOutputPin : public CTransformOutputPin
{
...
public:
    ...
    void DLL_EXPORT SetAllocator(IMemAllocator * pAllocator);

    __out_opt IMemInputPin * DLL_EXPORT ConnectedIMemInputPin()
        { return m_pInputPin; }
...
class AM_NOVTABLE DLL_EXPORT CTransInPlaceFilter : public CTransformFilter
{
...
public:
    ...
    HRESULT DLL_EXPORT DecideBufferSize(IMemAllocator*, __inout ALLOCATOR_PROPERTIES *);
    ...
    HRESULT DLL_EXPORT CompleteConnect(PIN_DIRECTION dir,IPin *pReceivePin);
    ...
    virtual HRESULT DLL_EXPORT Transform(IMediaSample *pSample) PURE;
...
protected:
    ...
    __out_opt IMediaSample * DLL_EXPORT Copy(IMediaSample *pSource);
    ...
    BOOL DLL_EXPORT UsingDifferentAllocators() const
    {
