...
private:
    ...
    /* These override the default copy constructor and assignment
       ...
       allocated data.
    */
    DLL_EXPORT CBaseList(const CBaseList &refList);
    DLL_EXPORT CBaseList &operator=(const CBaseList &refList);

public:

    DLL_EXPORT CBaseList(__in_opt LPCTSTR pName,
              INT iItems);

    DLL_EXPORT CBaseList(__in_opt LPCTSTR pName);
#ifdef UNICODE
    DLL_EXPORT CBaseList(__in_opt LPCSTR pName,
              INT iItems);

    DLL_EXPORT CBaseList(__in_opt LPCSTR pName);
#endif
    DLL_EXPORT ~CBaseList();

    /* Remove all the nodes from *this i.e. make the list empty */
    void DLL_EXPORT RemoveAll();


    /* Return a cursor which identifies the first element of *this */
    __out_opt POSITION DLL_EXPORT GetHeadPositionI() const;


    /* Return a cursor which identifies the last element of *this */
    __out_opt POSITION DLL_EXPORT GetTailPositionI() const;


    /* Return the number of objects in *this */
    int DLL_EXPORT GetCountI() const;
...
protected:
    ...
    */
    __out void * DLL_EXPORT GetNextI(__inout POSITION& rp) const;


    /* Return a pointer to the object at p
       Asking for the object at NULL will return NULL harmlessly.
    */
    __out_opt void * DLL_EXPORT GetI(__in_opt POSITION p) const;
    __out void * DLL_EXPORT GetValidI(__in POSITION p) const;
...
public:
    ...
    */
    __out_opt POSITION DLL_EXPORT Next(__in_opt POSITION pos) const
    {
        if (pos == NULL) {
    ...
    // See Next
    __out_opt POSITION DLL_EXPORT Prev(__in_opt POSITION pos) const
    {
        if (pos == NULL) {
    ...
    */
protected:
    __out_opt POSITION DLL_EXPORT FindI( __in void * pObj) const;
    ...
    */
    __out_opt void * DLL_EXPORT RemoveHeadI();
    ...
    /* Remove the last node in *this (deletes the pointer to its
       ...
       If *this was already empty it will harmlessly return NULL.
    */
    __out_opt void * DLL_EXPORT RemoveTailI();
    ...
    */
    __out_opt void * DLL_EXPORT RemoveI(__in_opt POSITION p);
    ...
    */
    __out_opt POSITION DLL_EXPORT AddTailI(__in void * pObj);
public:
    ...
    */
    BOOL DLL_EXPORT AddTail(__in CBaseList *pList);
    ...
    */
protected:
    __out_opt POSITION DLL_EXPORT AddHeadI(__in void * pObj);
public:
    ...
    */
    BOOL DLL_EXPORT AddHead(__in CBaseList *pList);
    ...
    */
protected:
    __out_opt POSITION DLL_EXPORT AddAfterI(__in_opt POSITION p, __in void * pObj);
public:
    ...
    /* Add the list *pList to *this after position p in *this
       ...
       Existing POSITIONs in *this are undisturbed, including p.
    */
    BOOL DLL_EXPORT AddAfter(__in_opt POSITION p, __in CBaseList *pList);
    ...
    */
    protected:
    __out_opt POSITION DLL_EXPORT AddBeforeI(__in_opt POSITION p, __in void * pObj);
    public:
    ...
    /* Add the list *pList to *this before position p in *this
       ...
       Existing POSITIONs in *this are undisturbed, including p.
    */
    BOOL DLL_EXPORT AddBefore(__in_opt POSITION p, __in CBaseList *pList);
    ...
    */
    BOOL DLL_EXPORT MoveToTail(__in_opt POSITION pos, __in CBaseList *pList);
    ...
    */
    BOOL DLL_EXPORT MoveToHead(__in_opt POSITION pos, __in CBaseList *pList);


    /* Reverse the order of the [pointers to] objects in *this
    */
    void DLL_EXPORT Reverse();
